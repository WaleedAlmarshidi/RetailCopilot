...
namespace RetailCopilot.Migrations
{
    ...
    [Migration("20240625001016_FromPartnersToUsersWithPosSalesV2")]
    partial class FromPartnersToUsersWithPosSalesV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailCopilot.Partner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RetailCopilot.PosSale", b =>
                {
                    ...
                    b.HasOne("RetailCopilot.Partner", null)
                        .WithMany("PosSales")
